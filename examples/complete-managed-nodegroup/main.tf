...
module "eks" {
  ...
  managed_node_groups = {
    managed_ng1 = {
      ...
      iam_role_arn              = module.eks.aws_iam_role_managed_ng_arn # custom IAM role for aws-auth mapping; used when create_iam_role = false
      iam_instance_profile_name = module.eks.aws_iam_instance_profile_managed_ng_name
