...
module "eks" {
  ...
  self_managed_node_groups = {
    self_mg1 = {
      ...
      iam_role_arn              = module.eks.aws_iam_role_self_managed_role_arn              # custom IAM role for aws-auth mapping; used when create_iam_role = false
      iam_instance_profile_name = module.eks.aws_iam_instance_profile_name # IAM instance profile name for Launch templates; used when create_iam_role = false
