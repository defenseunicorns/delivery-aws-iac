...
module "eks_blueprints" {
  ...
  self_managed_node_groups = { # can posible add a var.node.group.type and pass up to main for choice need to check how different
    self_mg1 = {
      ...
      iam_role_arn              = var.iam_role_arn              # custom IAM role for aws-auth mapping; used when create_iam_role = false
      iam_instance_profile_name = var.iam_instance_profile_name # IAM instance profile name for Launch templates; used when create_iam_role = false
