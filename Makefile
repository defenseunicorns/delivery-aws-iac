...
# the build folder.
ZARF_VERSION := v0.23.4-30-g19deddef
...
TF_ENV_DIR := "./examples/zarf-complete-example"
TF_ENV := "zarf-complete-example"
TF_ENV_STATE_DIR := "./examples/zarf-tf-state-backend"
TF_ENV_STATE := "zarf-tf-state-backend"
